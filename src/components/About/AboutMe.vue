				...
				<div class="row justify-content-center">
					<div class="col-md-6 col-sm-6">
						<div class="box">
							<div class="card">
								<div class="imgBx">
									<img :src="`${imageUrlFor(persons[3].aboutImage)}`" alt="images"/>
								</div>
								<div class="details">
									<h2>{{persons[3].name}}<br>
										<span>
											{{persons[3].aboutImage.caption}}
										</span>
									</h2>
								</div>
							</div>
					...
					<div class="col-md-12 col-sm-12" :style="`${$isMobile() ? '' :'margin-left: 21rem; margin-top: 2.5rem;'}`">
						<div class="card__profiles-col2">
							...
							<br>
							<span>
								{{persons[3].bio[6].children[0].text}}
							</span>

							<ul class="list-group mb-3">
								<div v-for="item in 11">
									<li v-if="item > 7" class="list-group-item" v-html="persons[3].bio[item].children[0].text"></li>
								</div>
							</ul>
